package com.myproject.appconnectionapi
...
import com.myproject.appconnectionapi.api.MyRetrofit
    ...
    private fun getData() {
        ...
        call.enqueue(object : Callback<List<Product>> {
            override fun onResponse(
                ...
                val adapter =
                    response?.body()?.let { ProductAdapter(this@MainActivity, it.toList()) }
